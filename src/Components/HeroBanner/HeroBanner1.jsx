...
const HeroBanner1 = () => {
    ...
    useEffect(() => {
	  ...
	  const handelClick = () => {
		setIframeSrc("https://calendly.com/probild-info/30min");
		setToggle(!toggle);
	  };
	  const handelClose = () => {
      ...
      const heroContent = {
        ...
        subtitle:"Let's Craft Your ",
        title:'Online Presence',
        content:'With PROBILD Your One Stop Solutions For All You Need For Your Website',
        content2:'We had an amazing experience working with Probild for our website development. They understood our vision perfectly and created a modern, user-friendly, and SEO-optimized website that truly represents The Bageecha Farm. Their team was highly professional, responsive, and dedicated to delivering a top-notch solution. We highly recommend Probild to anyone looking for high-quality website design and development services! ',
