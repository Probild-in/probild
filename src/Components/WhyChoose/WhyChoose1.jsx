...
const WhyChoose1 = () => {
    ...
    const chooseContent = {  
        ...
        title:'Meet Our Expert Team – Elevating Your Digital Presence',
        content:'we are more than just a web development company – we are your strategic digital partners. Our expert team of developers, designers, and marketers is dedicated to building high-performance, SEO-friendly, and visually stunning websites that drive business growth.',  
        img:'/assets/img/team/01.png',         
        list1:'Custom Website Development', 
        list2:'SEO-Optimized Solutions', 
        list3:'CRM & Business Automation', 
        list4:'Cutting-Edge UI/UX Design',
        list5:'24/7 Support & Maintenance',
        list6:'100% Client Satisfaction', 
      }  
                            ...
                            <div className="team-content">
                                ...
                                <div className="list-items wow fadeInUp" data-wow-delay=".3s">
                                 ...
                                 <div className="main-button wow fadeInUp" data-wow-delay=".5s">
                                    <Link to="https://calendly.com/probild-info/30min"> <span className="theme-btn"> EXPLORE MORE </span><span className="arrow-btn"><i className="bi bi-arrow-right"></i></span></Link>
                                </div>
                            </div>
                        </div>
                    </div>
